	...
	public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
		http
				...
				.authorizeHttpRequests(authorize -> authorize
						...
						.requestMatchers("/api/demo/setup").hasAnyRole("OPS", "ADMIN")
						.requestMatchers(
								"/api/demo/accounts",
								"/api/demo/accounts/lookup",
								"/api/demo/accounts/*/activity",
								"/api/demo/accounts/*")
						.hasAnyRole("USER", "OPS", "ADMIN")
					.requestMatchers("/api/demo/transfers/internal").hasAnyRole("USER", "OPS", "ADMIN")
					.requestMatchers("/api/demo/payments/**").hasAnyRole("USER", "OPS", "ADMIN")
					.requestMatchers(
								"/api/payments/**",
								"/api/transfers/internal",
								"/api/lending/disburse",
